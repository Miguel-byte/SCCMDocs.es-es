---
title: "Crear e implementar una aplicación | Microsoft Docs"
...
3.  En la lista de aplicaciones, seleccione la aplicación que creó anteriormente, **Aplicación Contoso**y, en la pestaña **Inicio** del grupo **Implementación**, elija **Implementar**.  

4.  En la página **General** del **Asistente para implementar software**, elija **Examinar** para seleccionar la recopilación de dispositivos **Todos los sistemas** .  
...
8.  En la página **Experiencia del usuario**, elija **Siguiente** para aceptar los valores predeterminados.  
...
4.  En la pestaña **Inicio** , en el grupo **Implementación** , elija **Ver estado**.  

5.  Seleccione una de las siguientes pestañas para ver más actualizaciones de estado acerca de la implementación de la aplicación:  
