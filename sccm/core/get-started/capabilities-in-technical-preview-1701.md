...
Para más información sobre los grupos de límites, vea [Grupos de límites](/sccm/core/servers/deploy/configure/define-site-boundaries-and-boundary-groups#BKMK_BoundaryGroups) en el contenido de la Rama actual.
