...
- **Conservación del texto de búsqueda:**  
  Cuando escribe texto en el cuadro de texto de búsqueda y, después, cambia el nodo en el que está buscando, ahora el texto que ha escrito se conserva y permanece disponible para su uso sin tener que volver a escribirlo.  
