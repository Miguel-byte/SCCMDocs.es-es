...
- [Las recopilaciones que se han cambiado de nombre se muestran en las reglas de pertenencia de la recopilación existentes](https://configurationmanager.uservoice.com/forums/300492-ideas/suggestions/20125567-fix-the-renaming-of-collections): si una recopilación es miembro de otra y se le cambia el nombre, el nuevo nombre se actualiza en las reglas de pertenencia.<!--1357282--> 
