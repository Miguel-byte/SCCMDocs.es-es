...
-   **Administración de aplicaciones:**
  ...
  -   ***[Actualizado]*** Información básica de uso o destino para tipos de implementación usados en la organización (usuario frente a dispositivo de destino, necesario frente a disponible, aplicaciones universales)  

  -  ***[Actualizado]*** Información sobre la implementación de aplicaciones (instalación o desinstalación, necesita aprobación, interacción de usuario habilitada o deshabilitada, dependencia, sustitución)  
...
-   **Configuración de cumplimiento:**
    ...
    -  ***[Nuevo]*** Recuento de certificado SCEP, VPN, Wi-Fi, certificado (.pfx) e implementaciones de directiva de cumplimiento por plataforma
...
-   **Actualizaciones de software:**
    ...
    -   ***[Nuevo]*** Clasificaciones sincronizadas por punto de actualización de software
...
-   **Datos de SQL o de rendimiento:**
    ...
    -   ***[Actualizado]*** Estadísticas de evaluación de la recopilación (tiempo de consulta, cantidades asignadas y sin asignar, recuentos por tipo, sustitución de identificador y uso de reglas)
...
-   ***[Nuevo]*** Configuración de cumplimiento: SCEP, VPN, Wifi y detalles de configuración de plantilla de Directiva de cumplimiento
