...
System Center Configuration Manager admite un sistema eficaz de herramientas y opciones para administrar el contenido que se implementa, como aplicaciones, paquetes, actualizaciones de software e implementaciones de sistema operativo.  
 ...
 El contenido que se implementa se almacena en los servidores de sitio y en los servidores de sistema de sitio de punto de distribución. Este contenido puede requerir una gran cantidad de ancho de banda de red al realizar transferencias entre ubicaciones.  Para planear y usar eficazmente la infraestructura de administración de contenido, debe conocer las opciones y configuraciones disponibles, y luego considerar cómo usarlas para adaptarse mejor a su entorno de red y a sus necesidades de implementación de contenido.  

Estos son los conceptos básicos de la administración de contenido. Cuando un concepto requiere información adicional o compleja, se proporcionan vínculos para dirigirle a ella.  
...
-   **Cuenta de acceso a la red**: la usan los clientes para conectarse a un punto de distribución y tener acceso al contenido. De forma predeterminada, los clientes primero probarán con su cuenta de equipo.  
...
-   Cuando los archivos del contenido de origen cambian, Configuration Manager crea una nueva versión incremental del conjunto de contenido y replica solamente los archivos cambiados en sitios de destino y puntos de distribución. Se considera que un archivo ha cambiado cuando cambia el nombre, se mueve o cambia su contenido. Por ejemplo, si sustituye un solo archivo de controlador del paquete de implementación de un sistema operativo distribuido anteriormente a varios sitios, solo se replica el archivo de controlador cambiado a esos sitios de destino.  
...
## <a name="branchcache"></a>BranchCache  
 Tecnología de Windows que habilita a los clientes que admiten BranchCache y que descargaron una implementación configurada para BranchCache, de modo que después puedan actuar como un origen de contenido para otros clientes habilitados para BranchCache.  
...
-   Puede usar los controles como **programaciones** o **el límite de ancho de banda** para ayudar a controlar esta transferencia.  

-   También puede utilizar otras opciones, entre las que se incluyen **contenido preconfigurado**, **puntos de distribución de extracción** o sacar provecho de **BranchCache** para reducir el ancho de banda de red que se utiliza al implementar contenido.  

-   Los puntos de distribución admiten distintas configuraciones como **[PXE](../../../osd/get-started/prepare-site-system-roles-for-operating-system-deployments.md#BKMK_PXEDistributionPoint)** y **[Multicast](../../../osd/get-started/prepare-site-system-roles-for-operating-system-deployments.md#BKMK_DPMulticast)** para las implementaciones del sistema operativo o configuraciones que admiten **dispositivos móviles**  
...
**Por ejemplo,** si distribuye contenido con una prioridad de distribución alta en un punto de distribución con una prioridad de punto de distribución baja, este paquete de prioridad de distribución alta siempre se transferirá antes que un paquete con una prioridad inferior. La prioridad de la distribución se aplica incluso si los paquetes que tienen una prioridad de distribución inferior se distribuyen a puntos de distribución con prioridades de punto de distribución mayores. Una prioridad de distribución alta del paquete garantiza que Configuration Manager distribuirá el contenido a los puntos de distribución aplicables antes de que se envíen paquetes con una prioridad de distribución inferior.  
...
-   Usar contenido preconfigurado: proceso de transferencia de contenido a un punto de distribución sin depender de Configuration Manager para distribuir el contenido a través de la red.  
...
-   Cuando esta opción está habilitada para una implementación y un cliente intenta solicitar ese contenido pero dicho contenido no está disponible en ninguno de los puntos de distribución preferidos de los clientes, Configuration Manager distribuye automáticamente el contenido a los puntos de distribución preferidos de los clientes.  
