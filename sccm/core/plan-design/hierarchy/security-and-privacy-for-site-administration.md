...
## <a name="BKMK_Security_Sites"></a> Guía de seguridad para la administración de sitios
...
Para más información, vea [Controles criptográficos para la comunicación de servidor](/sccm/core/plan-design/security/cryptographic-controls-technical-reference#cryptographic-controls-for-server-communication).  
...
Para obtener más información sobre las diferentes tecnologías de Wake on LAN, vea [Planear la reactivación de clientes en System Center Configuration Manager](/sccm/core/clients/deploy/plan/plan-wake-up-clients).
...
## <a name="BKMK_Security_SiteServer"></a> Guía de seguridad del servidor del sitio
...
## <a name="BKMK_Security_SQLServer"></a> Guía de seguridad de SQL Server
...
## <a name="BKMK_Security_IIS"></a> Guía de seguridad de los sistemas de sitio que ejecutan IIS
...
Instale sólo las funciones de IIS mínimas necesarias para el rol de sistema de sitio que vaya a instalar. Para obtener más información, consulte [Site and site system prerequisites](/sccm/core/plan-design/configs/site-and-site-system-prerequisites) (Requisitos previos de sitio y sistema de sitio).  
...
Identifique y siga la guía general de la versión del servidor IIS. Tenga en cuenta cualquier requisito que Configuration Manager tenga en cuanto a los roles de sistema de sitio específicos. Para obtener más información, consulte [Site and site system prerequisites](/sccm/core/plan-design/configs/site-and-site-system-prerequisites) (Requisitos previos de sitio y sistema de sitio).  


## <a name="BKMK_Security_ManagementPoint"></a> Guía de seguridad del punto de administración
...
## <a name="BKMK_Security_FSP"></a> Guía de seguridad del punto de estado de reserva

Si instala un punto de estado de reserva en Configuration Manager, use la siguiente guía de seguridad:

Para obtener más información sobre las consideraciones de seguridad al instalar un punto de estado de reserva, consulte [Determinar si necesita un punto de estado de reserva](/sccm/core/clients/deploy/plan/determine-the-site-system-roles-for-clients#fallback-status-point).  
