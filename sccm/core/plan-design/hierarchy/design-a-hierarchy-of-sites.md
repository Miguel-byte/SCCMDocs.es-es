...
- Instale nuevos sitios secundarios debajo de un sitio primario, hasta alcanzar el [número máximo admitido del sitio primario](/sccm/core/plan-design/configs/size-and-scale-numbers) y la jerarquía general.  
