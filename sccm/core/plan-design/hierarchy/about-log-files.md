...
#### <a name="bkmk_reg-role"></a> Opciones de registro de rol de sistema de sitio
...
#### <a name="bkmk_reg-console"></a> Opciones de registro de consolas de Configuration Manager
