...
Para más información sobre cómo configurar vínculos de replicación, consulte [Controles de replicación de base de datos del sitio](#BKMK_DBRepControls). Para más información sobre cómo supervisar la replicación, consulte [Supervisión de replicación de base de datos](/sccm/core/servers/manage/monitor-replication).  
...
## <a name="BKMK_schedules"></a> Programación de transferencias de datos del sitio
...
## <a name="BKMK_SummarizeDBReplication"></a> Resumen del tráfico  
...
Para más información sobre cómo supervisar la replicación de bases de datos, incluido cómo ver el estado de una replicación, consulte [Supervisión de la replicación de base de datos](/sccm/core/servers/manage/monitor-replication).  
...
[Solución de problemas de replicación de SQL](/sccm/core/servers/manage/replication/overview)
