...
-   Servidor de base de datos del sitio  
     ...
     No se admiten servidores de base de datos del sitio en un controlador de dominio de solo lectura (RODC). Para obtener más información, consulte [Puede encontrar problemas al instalar a SQL Server en un controlador de dominio](https://go.microsoft.com/fwlink/p/?LinkId=264856) en Microsoft Knowledge Base. Además, los servidores de sitio secundario no se admiten en ningún controlador de dominio.  
...
## <a name="windows-server-2008-r2-with-sp1-x64-standard-enterprise-and-datacenter"></a>Windows Server 2008 R2 con SP1 (x64): Standard, Enterprise y Datacenter  
 ...
 Este sistema operativo no es compatible con servidores de sitio o la mayoría de los roles del sistema de sitio. Todavía se admite para el rol de sistema de sitio del punto de distribución, incluidos los puntos de distribución de extracción y para PXE y multidifusión.

**Servidores de sistema de sitio:**  
-   Punto de distribución  

    -   Los puntos de distribución de este sistema operativo no son compatibles con Multidifusión.  

    -   Los puntos de distribución de este sistema operativo son compatibles con PXE.
...
Este sistema operativo no se admite para servidores de sitio o roles del sistema de sitio, excepto para el punto de distribución y el punto de distribución de extracción. Se puede seguir usando este sistema operativo como un punto de distribución hasta que se anuncie que esta compatibilidad queda obsoleta o expire el período extendido de soporte técnico de este sistema operativo. Para más información, vea [Installation of System Center Configuration Manager CB and LTSB fails on Windows Server 2008](https://support.microsoft.com/help/4015095) (La instalación de System Center Configuration Manager CB y LTBS produce un error en Windows Server 2008).
...
-   Punto de distribución  
    ...
    -   Los puntos de distribución de este sistema operativo son compatibles con PXE, pero no admiten el arranque de red de los equipos cliente en modo EFI. Se admiten los equipos cliente con arranque de EFI o BIOS en modo heredado.  
