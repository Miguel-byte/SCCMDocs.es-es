...
Para más información sobre los niveles y la configuración de los datos de uso, vea [Diagnósticos y datos de uso](/sccm/core/plan-design/diagnostics/diagnostics-and-usage-data).
...
Para obtener más información, vea [Endpoint Protection](/sccm/protect/deploy-use/endpoint-protection).
