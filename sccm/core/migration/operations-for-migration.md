---
title: "Operaciones de migración | Microsoft Docs"
...
9. En la página **Configuración**, configure cuándo debe ejecutarse el trabajo de migración y seleccione las opciones de configuración adicionales que necesite para este trabajo de migración. A diferencia de otros tipos de trabajo migración, este trabajo de migración debe sobrescribir los objetos migrados anteriormente en la base de datos de System Center Configuration Manager. Elija **Siguiente**.  
