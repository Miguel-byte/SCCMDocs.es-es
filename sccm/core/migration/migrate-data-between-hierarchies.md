...
##  <a name="BKMK_MigrationConcepts"></a> Conceptos  
...
Para obtener más información, consulte [Jerarquías de origen](/sccm/core/migration/planning-a-source-hierarchy-strategy#BKMK_Source_Hierarchies).
...
Para obtener más información, consulte [Sitios de origen](/sccm/core/migration/planning-a-source-hierarchy-strategy#BKMK_Source_Sites).
...
Para obtener más información, consulte [Recopilación de datos](/sccm/core/migration/planning-a-source-hierarchy-strategy#BKMK_Data_Gathering).
...
Para obtener más información, consulte [Planear una estrategia de trabajo de migración](/sccm/core/migration/planning-a-migration-job-strategy).
...
Para obtener más información, consulte [Planear una estrategia de migración de clientes](/sccm/core/migration/planning-a-client-migration-strategy).
...
Para obtener más información, consulte[Compartir puntos de distribución entre jerarquías de origen y de destino](/sccm/core/migration/planning-a-content-deployment-migration-strategy#About_Shared_DPs_in_Migration).
...
Para obtener más información, consulte [Planear la supervisión de la actividad de migración](/sccm/core/migration/planning-to-monitor-migration-activity).
...
Para obtener más información, consulte [Planear la finalización de la migración](/sccm/core/migration/planning-to-complete-migration).
...
##  <a name="BKMK_MigrationScenarios"></a>Escenarios  
...
### <a name="bkmk_2012"></a> Migración desde Configuration Manager 2012 o desde otra jerarquía de Configuration Manager  
...
-   [Planear la migración a Configuration Manager](/sccm/core/migration/planning-for-migration)  

-   [Configurar jerarquías de origen y sitios de origen para la migración](/sccm/core/migration/configuring-source-hierarchies-and-source-sites-for-migration)  

-   [Operaciones de migración](/sccm/core/migration/operations-for-migration)  

-   [Seguridad y privacidad de la migración](/sccm/core/migration/security-and-privacy-for-migration)  

-   [Comenzar a usar Configuration Manager](/sccm/core/servers/deploy/start-using)
