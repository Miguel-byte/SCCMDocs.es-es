...
### <a name="step-7-configure-client-settings-for-enrollment"></a>Paso 7: configurar el cliente para la inscripción  
...
#### <a name="to-uninstall-the-mac-client"></a>Para desinstalar el cliente Mac  
