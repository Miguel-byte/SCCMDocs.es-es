...
### <a name="you-cannot-deploy-windows-defenderscep-policies-to-client-devices-without-domain-connectivity"></a>No se pueden implementar directivas de Windows Defender/SCEP en los dispositivos cliente sin conectividad de dominio
<!-- 4350561 -->
*Se aplica a: Versión 1902 y versiones anteriores de Configuration Manager*

Cuando el cliente de Configuration Manager aplica las directivas de Windows Defender/SCEP, se requiere una actualización de la directiva de grupo que no funciona cuando no se puede acceder al dominio. Este problema afecta a los dispositivos administrados por CMG a través de Internet.
