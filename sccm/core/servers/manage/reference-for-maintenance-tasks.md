...
**Eliminar historial de inventario antiguo**: Utilice esta tarea para eliminar datos de inventario almacenados durante más tiempo del especificado en la base de datos. Para obtener información sobre el historial de inventario, consulte [Cómo usar el Explorador de recursos para ver el inventario de Hardware en Configuration Manager](../../../core/clients/manage/inventory/use-resource-explorer-to-view-hardware-inventory.md).  
