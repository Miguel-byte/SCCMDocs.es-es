# [Introducción](configuration-manager-reference.md)
...
# [Clases del proveedor de contenido alternativo](core/servers/configure/alternate-content-provider-classes.md)
...
## [Clase WMI de servidor SMS_ApplicationAssignment](apps/sms_applicationassignment-server-wmi-class.md)
...
## [Clase WMI de servidor SMS_DeploymentTypeLicenseAssociation](apps/sms_deploymenttypelicenseassociation-server-wmi-class.md)
...
# [Clases de cliente](core/clients/client-classes/client-classes.md)
...
### [Clase WMI de cliente SMS_InstalledExecutable](core/clients/client-classes/sms_installedexecutable-client-wmi-class.md)
...
#### [Método GetAssignedSite de la clase SMS_Client](core/clients/client-classes/getassignedsite-method-in-class-sms_client.md)
...
### [Clase WMI de cliente CCM_Policy_ExpressionHandlerRegistration](core/clients/client-classes/ccm_policy_expressionhandlerregistration-client-wmi-class.md)
...
### [Clase WMI de cliente InventoryDataContext](core/clients/client-classes/inventorydatacontext-client-wmi-class.md)
...
### [Clase WMI de cliente CCM_Scheduler_ScheduledMessage](core/clients/client-classes/ccm_scheduler_scheduledmessage-client-wmi-class.md)
...
## [Clase WMI de servidor SMS_BigGreenButtonConfig](core/clients/config/sms_biggreenbuttonconfig-server-wmi-class.md)
...
## [Clase WMI de servidor SMS_PolicyAgentConfig](core/clients/config/sms_policyagentconfig-server-wmi-class.md)
...
## [Clase WMI de servidor SMS_ClientDataSourcesPolicy](core/clients/deploy/sms_clientdatasourcespolicy-server-wmi-class.md)
...
### [Método Uninstall de la clase CCM_Application](core/clients/sdk/uninstall-method-in-class-ccm_application.md)
...
### [Método GetAutoInstallRequiredSoftwaretoNonBusinessHours de la clase CCM_ClientUXSettings](core/clients/sdk/getautoinstallrequiredsoftwaretononbusinesshours-method.md)
...
### [Método PostponeProgramsToNonBusinessHours de la clase CCM_ProgramsManager](core/clients/sdk/postponeprogramstononbusinesshours-method-in-class-ccm_programsmanager.md)
...
### [Método GetClientVersion de la clase CCM_SoftwareCatalogUtilities](core/clients/sdk/getclientversion-method-in-class-ccm_softwarecatalogutilities.md)
...
## [Clase WMI de servidor SMS_CH_SummaryHistory](core/clients/status/sms_ch_summaryhistory-server-wmi-class.md)
...
### [Método ClientEditions de la clase SMS_Collection](core/clients/collections/clienteditions-method-in-class-sms_collection.md)
...
## [Clase WMI de servidor SMS_CollectionBucket](core/clients/collections/sms_collectionbucket-server-wmi-class.md)
...
## [Clase WMI de servidor SMS_FullCollectionMembership](core/clients/collections/sms_fullcollectionmembership-server-wmi-class.md)
...
## [Clase WMI de servidor SMS_ConfigurationBaselineInfo](compliance/sms_configurationbaselineinfo-server-wmi-class.md)
...
### [Método GetEULA de la clase SMS_ConfigurationPolicyBase](compliance/geteula-method-in-class-sms_configurationpolicybase.md)
...
### [Método GetEULA de la clase SMS_SettingsDefinitionBase](compliance/geteula-method-in-class-sms_settingsdefinitionbase.md)
...
### [Clase WMI de servidor SMS_SearchFolder](core/servers/console/sms_searchfolder-server-wmi-class.md)
...
## [Clase WMI de servidor SMS_DPGroupDistributionStatusDetails](core/servers/configure/sms_dpgroupdistributionstatusdetails-server-wmi-class.md)
...
### [Método CancelWipe de la clase SMS_DeviceMethods](mdm/cancelwipe-method-in-class-sms_devicemethods.md)
...
### [Interfaz ISMSResGen](core/servers/configure/ismsresgen-interface.md)
...
## [Clase WMI de servidor SMS_ClientOperationStatus](protect/sms_clientoperationstatus-server-wmi-class.md)
...
#### [Método SyncToken de la clase SMS_MDMAppleVppToken](mdm/synctoken-method-in-class-sms_mdmapplevpptoken.md)
...
### [Método GetEntityReferences de la clase SMS_MigrationEntity](core/migration/getentityreferences-method-in-class-sms_migrationentity.md)
...
# [Clases WMI de servidor NAP](misc/nap-server-wmi-classes.md)
...
## [Clase WMI de servidor SMS_PropertyDisplayNode](misc/sms_propertydisplaynode-server-wmi-class.md)
...
### [Método ProcessInBox de la clase SMS_SoftwareProductCompliance](misc/processinbox-method-in-class-sms_softwareproductcompliance.md)
...
#### [Propiedad ITsMediaClass::MediaLabel](misc/itsmediaclass--medialabel-property.md)
...
#### [Método RefreshPkgSource de la clase SMS_BootImagePackage](osd/refreshpkgsource-method-in-class-sms_bootimagepackage.md)
...
#### [Método AddChangeNotification de la clase SMS_DriverPackage](osd/addchangenotification-method-in-class-sms_driverpackage.md)
...
#### [Método SetSourceSite de la clase SMS_ImagePackage](osd/setsourcesite-method-in-class-sms_imagepackage.md)
...
### [Clase WMI de servidor SMS_OSDeploymentKitInstalledVersion](osd/sms_osdeploymentkitinstalledversion-server-wmi-class.md)
...
#### [Método DeleteAssociation de la clase SMS_StateMigration](osd/deleteassociation-method-in-class-sms_statemigration.md)
#### [Método GetEncryptDecryptKey de la clase SMS_StateMigration](osd/getencryptdecryptkey-method-in-class-sms_statemigration.md)
### [Clase WMI de servidor SMS_StateMigrationUserNames](osd/sms_statemigrationusernames-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence](osd/sms_tasksequence-server-wmi-class.md)
#### [Método ExportXml de la clase SMS_TaskSequence](osd/exportxml-method-in-class-sms_tasksequence.md)
#### [Método LoadFromXml de la clase SMS_TaskSequence](osd/loadfromxml-method-in-class-sms_tasksequence.md)
#### [Método SaveToXml de la clase SMS_TaskSequence](osd/savetoxml-method-in-class-sms_tasksequence.md)
### [Clase WMI de servidor SMS_TaskSequence_Action](osd/sms_tasksequence_action-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_ApplicationInfo](osd/sms_tasksequence_applicationinfo-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_ApplyDataImageAction](osd/sms_tasksequence_applydataimageaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_ApplyDriverPackageAction](osd/sms_tasksequence_applydriverpackageaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_ApplyNetworkSettingsAction](osd/sms_tasksequence_applynetworksettingsaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_ApplyOperatingSystemAction](osd/sms_tasksequence_applyoperatingsystemaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_ApplyWindowsSettingsAction](osd/sms_tasksequence_applywindowssettingsaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_AutoApplyAction](osd/sms_tasksequence_autoapplyaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_CaptureNetworkSettingsAction](osd/sms_tasksequence_capturenetworksettingsaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_CaptureSystemImageAction](osd/sms_tasksequence_capturesystemimageaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_CaptureUserStateAction](osd/sms_tasksequence_captureuserstateaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_CaptureWindowsSettingsAction](osd/sms_tasksequence_capturewindowssettingsaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_Condition](osd/sms_tasksequence_condition-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_ConditionExpression](osd/sms_tasksequence_conditionexpression-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_ConditionOperand](osd/sms_tasksequence_conditionoperand-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_ConditionOperator](osd/sms_tasksequence_conditionoperator-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_ConnectNetworkFolderAction](osd/sms_tasksequence_connectnetworkfolderaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_ConvertDiskAction](osd/sms_tasksequence_convertdiskaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_DisableBitLockerAction](osd/sms_tasksequence_disablebitlockeraction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_DownloadPackageContentAction](osd/sms_tasksequence_downloadpackagecontentaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_EnableBitLockerAction](osd/sms_tasksequence_enablebitlockeraction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_FileConditionExpression](osd/sms_tasksequence_fileconditionexpression-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_FolderConditionExpression](osd/sms_tasksequence_folderconditionexpression-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_Group](osd/sms_tasksequence_group-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_InstallApplicationAction](osd/sms_tasksequence_installapplicationaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_InstallDeployToolsAction](osd/sms_tasksequence_installdeploytoolsaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_InstallSoftwareAction](osd/sms_tasksequence_installsoftwareaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_InstallUpdateAction](osd/sms_tasksequence_installupdateaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_JoinDomainWorkgroupAction](osd/sms_tasksequence_joindomainworkgroupaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_NetworkAdapterSettings](osd/sms_tasksequence_networkadaptersettings-server-wmi-class.md)
### [SMS_TaskSequenc0e_OfflineEnableBitLockerAction](osd/sms_tasksequence_offlineenablebitlockeraction.md)
### [Clase WMI de servidor SMS_TaskSequence_OSConditionGroup](osd/sms_tasksequence_osconditiongroup-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_OSExpressionGroup](osd/sms_tasksequence_osexpressiongroup-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_PackageInfo](osd/sms_tasksequence_packageinfo-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_PartitionDiskAction](osd/sms_tasksequence_partitiondiskaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_PartitionSettings](osd/sms_tasksequence_partitionsettings-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_Pointer](osd/sms_tasksequence_pointer-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_PrepareOSAction](osd/sms_tasksequence_prepareosaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_PrepareSMSClientAction](osd/sms_tasksequence_preparesmsclientaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_RebootAction](osd/sms_tasksequence_rebootaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_Reference](osd/sms_tasksequence_reference-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_RegistryConditionExpression](osd/sms_tasksequence_registryconditionexpression-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_ReleaseStateStoreAction](osd/sms_tasksequence_releasestatestoreaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_RequestStateStoreAction](osd/sms_tasksequence_requeststatestoreaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_RestoreUserStateAction](osd/sms_tasksequence_restoreuserstateaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_RunCommandLineAction](osd/sms_tasksequence_runcommandlineaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_SetupWindowsAndSMSAction](osd/sms_tasksequence_setupwindowsandsmsaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_SetVariableAction](osd/sms_tasksequence_setvariableaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_SoftwareConditionExpression](osd/sms_tasksequence_softwareconditionexpression-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_Step](osd/sms_tasksequence_step-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_UpgradeOperatingSystemAction](osd/sms_tasksequence_upgradeoperatingsystemaction-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_VariableConditionExpression](osd/sms_tasksequence_variableconditionexpression-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequence_WMIConditionExpression](osd/sms_tasksequence_wmiconditionexpression-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequenceAppReferenceDps](osd/sms_tasksequenceappreferencedps-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequenceAppReferencesInfo](osd/sms_tasksequenceappreferencesinfo-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequencePackage](osd/sms_tasksequencepackage-server-wmi-class.md)
#### [Método AddChangeNotification de la clase SMS_TaskSequencePackage](osd/addchangenotification-method-in-class-sms_tasksequencepackage.md)
#### [Método AddDistributionPoints de la clase SMS_TaskSequencePackage](osd/adddistributionpoints-method-in-class-sms_tasksequencepackage.md)
#### [Método CheckReferencesShareType de la clase SMS_TaskSequencePackage](osd/checkreferencessharetype-method-in-class-sms_tasksequencepackage.md)
#### [Método GetClientConfigPolicies de la clase SMS_TaskSequencePackage](osd/getclientconfigpolicies-method-in-class-sms_tasksequencepackage.md)
#### [Método GetContentHash de la clase SMS_TaskSequencePackage](osd/getcontenthash-method-in-class-sms_tasksequencepackage.md)
#### [Método GetPackageDefaultHash de la clase SMS_TaskSequencePackage](osd/getpackagedefaulthash-method-in-class-sms_tasksequencepackage.md)
#### [Método GetPackageHash de la clase SMS_TaskSequencePackage](osd/getpackagehash-method-in-class-sms_tasksequencepackage.md)
#### [Método GetSequence de la clase SMS_TaskSequencePackage](osd/getsequence-method-in-class-sms_tasksequencepackage.md)
#### [Método GetTsPolicies de la clase SMS_TaskSequencePackage](osd/gettspolicies-method-in-class-sms_tasksequencepackage.md)
#### [Método GetTsPoliciesSaMedia de la clase SMS_TaskSequencePackage](osd/gettspoliciessamedia-method-in-class-sms_tasksequencepackage.md)
#### [Método GetTSRelatedToDriverCategory de la clase SMS_TaskSequencePackage](osd/gettsrelatedtodrivercategory-method-in-class-sms_tasksequencepackage.md)
#### [Método ImportSequence de la clase SMS_TaskSequencePackage](osd/importsequence-method-in-class-sms_tasksequencepackage.md)
#### [Método RefreshPkgSource de la clase SMS_TaskSequencePackage](osd/refreshpkgsource-method-in-class-sms_tasksequencepackage.md)
#### [Método SetSequence de la clase SMS_TaskSequencePackage](osd/setsequence-method-in-class-sms_tasksequencepackage.md)
#### [Método SetSourceSite de la clase SMS_TaskSequencePackage](osd/setsourcesite-method-in-class-sms_tasksequencepackage.md)
#### [Método Unlock de la clase SMS_TaskSequencePackage](osd/unlock-method-in-class-sms_tasksequencepackage.md)
### [Clase WMI de servidor SMS_TaskSequencePackageReference](osd/sms_tasksequencepackagereference-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequenceReferenceDps](osd/sms_tasksequencereferencedps-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequenceReferencesInfo](osd/sms_tasksequencereferencesinfo-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequencePackageReference_All](osd/sms_tasksequencepackagereference_all-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequencePackageReference_Flat](osd/sms_tasksequencepackagereference_flat-server-wmi-class.md)
### [Clase WMI de servidor SMS_TaskSequenceExecutionStatus](osd/sms_tasksequenceexecutionstatus-server-wmi-class.md)
### [Clase WMI de servidor SMS_UserSettings](osd/sms_usersettings-server-wmi-class.md)
### [Clase WMI de servidor SMS_UserVariable](osd/sms_uservariable-server-wmi-class.md)
### [Clase WMI de servidor SMS_VhdPackage](osd/sms_vhdpackage-server-wmi-class.md)
#### [Método AddChangeNotification de la clase SMS_VhdPackage](osd/addchangenotification-method-in-class-sms_vhdpackage.md)
#### [Método AddDistributionPoints de la clase SMS_VhdPackage](osd/adddistributionpoints-method-in-class-sms_vhdpackage.md)
#### [Método GetImageProperties de la clase SMS_VhdPackage](osd/getimageproperties-method-in-class-sms_vhdpackage.md)
#### [Método RefreshPkgSource de la clase SMS_VhdPackage](osd/refreshpkgsource-method-in-class-sms_vhdpackage.md)
#### [Método ReloadImageProperties de la clase SMS_VhdPackage](osd/reloadimageproperties-method-in-class-sms_vhdpackage.md)
#### [Método RunOfflineServicingManager de la clase SMS_VhdPackage](osd/runofflineservicingmanager-method-in-class-sms_vhdpackage.md)
#### [Método SetSourceSite de la clase SMS_VhdPackage](osd/setsourcesite-method-in-class-sms_vhdpackage.md)
#### [Método Unlock de la clase SMS_VhdPackage](osd/unlock-method-in-class-sms_vhdpackage.md)
### [Clase WMI de servidor SMS_WinPEOptionalComponentInBootImage](osd/sms_winpeoptionalcomponentinbootimage-server-wmi-class.md)
### [Clase WMI de servidor SMS_WinPEOptionalComponentInfo](osd/sms_winpeoptionalcomponentinfo-server-wmi-class.md)
### [CreateMedia.exe de implementación de sistema operativo](osd/operating-system-deployment-createmedia.exe.md)

# [Clases WMI de servidor de administración fuera de banda](misc/out-of-band-management-server-wmi-classes.md)
## [Clase WMI de servidor SMS_AMTCertificate](misc/sms_amtcertificate-server-wmi-class.md)
## [Clase WMI de servidor SMS_AMTMachineInfo](misc/sms_amtmachineinfo-server-wmi-class.md)

# [Clases WMI de servidor de informes](core/servers/reporting/configuration-manager-reporting-server-wmi-classes.md)
## [Clase WMI de servidor SMS_ReportViewSchema](core/servers/reporting/sms_reportviewschema-server-wmi-class.md)
### [Método GetSampleValues de la clase SMS_ReportViewSchema](core/servers/reporting/getsamplevalues-method-in-class-sms_reportviewschema.md)

# [Clases WMI de servidor de administración de recursos](core/clients/manage/configuration-manager-resource-management-server-wmi-classes.md)
## [Clases WMI de servidor de inventario de hardware](core/clients/manage/hardware-inventory-server-wmi-classes.md)
### [Clase WMI de servidor SMS_G_System_SYSTEM](core/clients/manage/sms_g_system_system-server-wmi-class.md)
### [Clase WMI de servidor SMS_G_Sysetm_WORKSTATION_STATUS](core/clients/manage/sms_g_system_workstation_status-server-wmi-class.md)
### [Clase WMI de servidor SMS_InventoryClass](core/clients/manage/sms_inventoryclass-server-wmi-class.md)
### [Clase WMI de servidor SMS_InventoryClassProperty](core/clients/manage/sms_inventoryclassproperty-server-wmi-class.md)
### [Clase WMI de servidor SMS_InventoryReport](core/clients/manage/sms_inventoryreport-server-wmi-class.md)
#### [Método ImportInventoryReport de la clase SMS_InventoryReport](core/clients/manage/importinventoryreport-method-in-class-sms_inventoryreport.md)
### [Clase WMI de servidor SMSInventoryReportClass](core/clients/manage/sms_inventoryreportclass-server-wmi-class.md)
## [Clase WMI de servidor SMS_G_System](core/clients/manage/sms_g_system-server-wmi-class.md)
## [Clase WMI de servidor SMS_G_System_AdvancedThreatProtectionHealthStatus](core/clients/manage/sms_g_system_advancedthreatprotectionhealthstatus-server-wmi-class.md)
## [Clase WMI de servidor SMS_G_System_CollectedFile](core/clients/manage/sms_g_system_collectedfile-server-wmi-class.md)
## [Clase WMI de servidor SMS_G_System_Current](core/clients/manage/sms_g_system_current-server-wmi-class.md)
## [Clase WMI de servidor SMS_G_System_ExHistory](core/clients/manage/sms_g_system_exthistory-server-wmi-class.md)
## [Clase WMI de servidor SMS_G_System_History](core/clients/manage/sms_g_system_history-server-wmi-class.md)
## [Clase WMI de servidor SMS_G_System_LastSoftwareScan](core/clients/manage/sms_g_system_lastsoftwarescan-server-wmi-class.md)
## [Clase WMI de servidor SMS_G_SYSTEM_ResourceClientSettingsAssignment](core/clients/manage/sms_g_system_resourceclientsettingsassignment-server-wmi-class.md)
## [Clase WMI de servidor SMS_G_System_SoftwareFile](core/clients/manage/sms_g_system_softwarefile-server-wmi-class.md)
## [Clase WMI de servidor SMS_G_System_SoftwareProduct](core/clients/manage/sms_g_system_softwareproduct-server-wmi-class.md)
## [Clase WMI de servidor SMS_G_System_UnknownFile](core/clients/manage/sms_g_system_unknownfile-server-wmi-class.md)
## [Clase WMI de servidor SMS_Group](core/clients/manage/sms_group-server-wmi-class.md)
## [Clase WMI de servidor SMS_PendingRegistrationRecord](core/clients/manage/sms_pendingregistrationrecord-server-wmi-class.md)
### [Método ResolvePendingRegistrationRecord de la clase SMS_PendingRegistrationRecord](core/clients/manage/resolvependingregistrationrecord-method-in-class-sms_pendingregistrationrecord.md)
## [Clase WMI de servidor SMS_Query](core/clients/manage/sms_query-server-wmi-class.md)
### [Método CreateCCRs de la clase SMS_Query](core/clients/manage/createccrs-method-in-class-sms_query.md)
### [Método FindResourceSite de la clase SMS_Query](core/clients/manage/findresourcesite-method-in-class-sms_query.md)
## [Clase WMI de servidor SMS_R_IPNetwork](core/clients/manage/sms_r_ipnetwork-server-wmi-class.md)
## [Clase WMI de servidor SMS_R_System](core/clients/manage/sms_r_system-server-wmi-class.md)
## [Clase WMI de servidor SMS_R_User](core/clients/manage/sms_r_user-server-wmi-class.md)
## [Clase WMI de servidor SMS_R_UserGroup](core/clients/manage/sms_r_usergroup-server-wmi-class.md)
## [Clase WMI de servidor SMS_ResIDValueLookup](core/clients/manage/sms_residvaluelookup-server-wmi-class.md)
## [Clase WMI de servidor SMS_Resource](core/clients/manage/sms_resource-server-wmi-class.md)
## [Clase WMI de servidor SMS_ResourceMap](core/clients/manage/sms_resourcemap-server-wmi-class.md)
### [Método GetClassesWithData de la clase SMS_ResourceMap](core/clients/manage/getclasseswithdata-method-in-class-sms_resourcemap.md)
### [Método Refresh de la clase SMS_ResourceMap](core/clients/manage/refresh-method-in-class-sms_resourcemap.md)
## [Clase WMI de servidor SMS_SoftwareConversionRules](core/clients/manage/sms_softwareconversionrules-server-wmi-class.md)
## [Clase WMI de servidor SMS_UserMachineRelationship](core/clients/manage/sms_usermachinerelationship-server-wmi-class.md)
### [Método Addsource de la clase SMS_UserMachineRelationship](core/clients/manage/addsource-method-in-class-sms_usermachinerelationship.md)
### [Método AddType de la clase SMS_UserMachineRelationship](core/clients/manage/addtype-method-in-class-sms_usermachinerelationship.md)
### [Método CreateRelationship de la clase SMS_UserMachineRelationship](core/clients/manage/createrelationship-method-in-class-sms_usermachinerelationship.md)
### [Método RemoveSource de la clase SMS_UserMachineRelationship](core/clients/manage/removesource-method-in-class-sms_usermachinerelationship.md)
### [Método RemoveType de la clase SMS_UserMachineRelationship](core/clients/manage/removetype-method-in-class-sms_usermachinerelationship.md)

# [Clases WMI de servidor de administración basada en roles](core/servers/configure/role-based-administration-server-wmi-classes.md)
## [Clase WMI de servidor SMS_Admin](core/servers/configure/sms_admin-server-wmi-class.md)
### [Método GetAdminExtendedData de la clase SMS_Admin](core/servers/configure/getadminextendeddata-method-in-class-sms_admin.md)
## [Clase WMI de servidor SMS_AdminCategory](core/servers/configure/sms_admincategory-server-wmi-class.md)
## [Clase WMI de servidor SMS_AdminRole](core/servers/configure/sms_adminrole-server-wmi-class.md)
## [Clase WMI de servidor SMS_APermission](core/servers/configure/sms_apermission-server-wmi-class.md)
## [Clase WMI de servidor SMS_ARoleOperation](core/servers/configure/sms_aroleoperation-server-wmi-class.md)
## [Clase WMI de servidor SMS_AssociatedSecuredCategory](core/servers/configure/sms_associatedsecuredcategory-server-wmi-class.md)
## [Clase WMI de servidor SMS_InitSettableSecuredCategory](core/servers/configure/sms_initsettablesecuredcategory-server-wmi-class.md)
## [Clase WMI de servidor SMS_LastCategoryObject](core/servers/configure/sms_lastcategoryobject-server-wmi-class.md)
## [Clase WMI de servidor SMS_Operation](core/servers/configure/sms_operation-server-wmi-class.md)
## [Clase WMI de servidor SMS_Permission](core/servers/configure/sms_permission-server-wmi-class.md)
## [Clase WMI de servidor SMS_RbacSecuredObject](core/servers/configure/sms_rbacsecuredobject-server-wmi-class.md)
### [Método GetAvailableScopes de la clase SMS_RbacSecuredObject](core/servers/configure/getavailablescopes-method-in-class-sms_rbacsecuredobject.md)
### [Método GetCollectionsWithResourcePermissions de la clase SMS_RbacSecuredObject](core/servers/configure/getcollectionswithresourcepermissions-method-in-class-sms_rbacsecuredobject.md)
### [Método GetUserList de la clase SMS_RbacSecuredObject](core/servers/configure/getuserlist-method-in-class-sms_rbacsecuredobject.md)
### [Método UserHasPermissions de la clase SMS_RbacSecuredObject](core/servers/configure/userhaspermissions-method-in-class-sms_rbacsecuredobject.md)
## [Clase WMI de servidor SMS_Role](core/servers/configure/sms_role-server-wmi-class.md)
### [Método ExportRole de la clase SMS_Role](core/servers/configure/exportrole-method-in-class-sms_role.md)
### [Método ImportRole de la clase SMS_Role](core/servers/configure/importrole-method-in-class-sms_role.md)
## [Clase WMI de servidor SMS_SecuredCategory](core/servers/configure/sms_securedcategory-server-wmi-class.md)
## [Clase WMI de servidor SMS_SecuredCategoryMembership](core/servers/configure/sms_securedcategorymembership-server-wmi-class.md)
### [Método AddMemberships de la clase SMS_SecuredCategoryMembership](core/servers/configure/addmemberships-method-in-class-sms_securedcategorymembership.md)
### [Método RemoveMemberships de la clase SMS_SecuredCategoryMembership](core/servers/configure/removememberships-method-in-class-sms_securedcategorymembership.md)
## [Clase WMI de servidor SMS_SettableSecuredCategory](core/servers/configure/sms_settablesecuredcategory-server-wmi-class.md)

# [Clases WMI de servidor de programación](core/servers/configure/scheduling-server-wmi-classes.md)
## [Clase WMI de servidor SMS_ScheduleMethods](core/servers/configure/sms_schedulemethods-server-wmi-class.md)
### [Método ReadFromString de la clase SMS_ScheduleMethods](core/servers/configure/readfromstring-method-in-class-sms_schedulemethods.md)
### [Método WriteToString de la clase SMS_ScheduleMethods](core/servers/configure/writetostring-method-in-class-sms_schedulemethods.md)
## [Clase WMI de servidor SMS_ScheduleToken](core/servers/configure/sms_scheduletoken-server-wmi-class.md)
## [Clase WMI de servidor SMS_ST_NonRecurring](core/servers/configure/sms_st_nonrecurring-server-wmi-class.md)
## [Clase WMI de servidor SMS_ST_RecurInterval](core/servers/configure/sms_st_recurinterval-server-wmi-class.md)
## [Clase WMI de servidor SMS_ST_RecurMonthlyByDate](core/servers/configure/sms_st_recurmonthlybydate-server-wmi-class.md)
## [Clase WMI de servidor SMS_ST_RecurMonthlyByWeekday](core/servers/configure/sms_st_recurmonthlybyweekday-server-wmi-class.md)
## [Clase WMI de servidor SMS_ST_RecurWeekly](core/servers/configure/sms_st_recurweekly-server-wmi-class.md)

# [Clases WMI de servidor SEDO](misc/sedo-server-wmi-classes.md)
## [Clase WMI de servidor SMS_ObjectLock](misc/sms_objectlock-server-wmi-class.md)
### [Método CancelLockRequest de la clase SMS_ObjectLock](misc/cancellockrequest-method-in-class-sms_objectlock.md)
### [Método CancelLockRequests de la clase SMS_ObjectLock](misc/cancellockrequests-method-in-class-sms_objectlock.md)
### [Método CheckLockRequest de la clase SMS_ObjectLock](misc/checklockrequest-method-in-class-sms_objectlock.md)
### [Método CheckLockRequests de la clase SMS_ObjectLock](misc/checklockrequests-method-in-class-sms_objectlock.md)
### [Método GetLockInformation de la clase SMS_ObjectLock](misc/getlockinformation-method-in-class-sms_objectlock.md)
### [Método ReleaseAllLocks de la clase SMS_ObjectLock](misc/releasealllocks-method-in-class-sms_objectlock.md)
### [Método ReleaseLock de la clase SMS_ObjectLock](misc/releaselock-method-in-class-sms_objectlock.md)
### [Método ReleaseLocks de la clase SMS_ObjectLock](misc/releaselocks-method-in-class-sms_objectlock.md)
### [Método RequestLock de la clase SMS_ObjectLock](misc/requestlock-method-in-class-sms_objectlock.md)
### [Método RequestLockAsync de la clase SMS_ObjectLock](misc/requestlockasync-method-in-class-sms_objectlock.md)
### [Método RequestLocks de la clase SMS_ObjectLock](misc/requestlocks-method-in-class-sms_objectlock.md)
### [Método RequestLocksAsync de la clase SMS_ObjectLock](misc/requestlocksasync-method-in-class-sms_objectlock.md)
## [Clase WMI de servidor SMS_ObjectLockRequest](misc/sms_objectlockrequest-server-wmi-class.md)

# [Clases WMI de servidor de configuración de sitio](core/servers/configure/site-configuration-server-wmi-classes.md)
## [Clase WMI de servidor SMS_Boundary](core/servers/configure/sms_boundary-server-wmi-class.md)
## [Clase WMI de servidor SMS_BoundaryGroup](core/servers/configure/sms_boundarygroup-server-wmi-class.md)
### [Método AddBoundary de la clase SMS_BoundaryGroup](core/servers/configure/addboundary-method-in-class-sms_boundarygroup.md)
### [Método AddSiteSystem de la clase SMS_BoundaryGroup](core/servers/configure/addsitesystem-method-in-class-sms_boundarygroup.md)
### [Método RemoveBoundary de la clase SMS_BoundaryGroup](core/servers/configure/removeboundary-method-in-class-sms_boundarygroup.md)
### [Método RemoveSiteSystem de la clase SMS_BoundaryGroup](core/servers/configure/removesitesystem-method-in-class-sms_boundarygroup.md)
## [Clase WMI de servidor SMS_BoundaryGroupMembers](core/servers/configure/sms_boundarygroupmembers-server-wmi-class.md)
## [Clase WMI de servidor SMS_BoundaryGroupRelationships](core/servers/configure/sms-boundarygrouprelationships-server-wmi-class.md)
### [Método FallbackDP de la clase SMS_BoundaryGroupRelationships](core/servers/configure/fallbackdp-method-in-class-sms-boundarygrouprelationships.md)
### [Método FallbackMP de la clase SMS_BoundaryGroupRelationships](core/servers/configure/fallbackmp-method-in-class-sms-boundarygrouprelationships.md)
### [Método FallbackSMP de la clase SMS_BoundaryGroupRelationships](core/servers/configure/fallbacksmp-method-in-class-sms-boundarygrouprelationships.md)
### [Método FallbackSUP de la clase SMS_BoundaryGroupRelationships](core/servers/configure/fallbacksup-method-in-class-sms-boundarygrouprelationships.md)
## [Clase WMI de servidor SMS_BoundaryGroupSiteSystems](core/servers/configure/sms_boundarygroupsitesystems-server-wmi-class.md)
## [Clase WMI de servidor SMS_Client_Reg_MultiString_List](core/servers/configure/sms_client_reg_multistring_list-server-wmi-class.md)
## [Clase WMI de servidor SMS_CMSiteConfiguration](core/servers/configure/sms_cmsiteconfiguration-server-wmi-class.md)
## [Clase WMI servidor SMS_DefaultBoundaryGroup](core/servers/configure/sms-defaultboundarygroup-server-wmi-class.md)
### [Método AddBoundary de la clase SMS_DefaultBoundaryGroup](core/servers/configure/addboundary-method-in-class-sms-defaultboundarygroup.md)
### [Método AddSiteSystem de la clase SMS_DefaultBoundaryGroup](core/servers/configure/addsitesystem-method-in-class-sms-defaultboundarygroup.md)
### [Método RemoveBoundary de la clase SMS_DefaultBoundaryGroup](core/servers/configure/removeboundary-method-in-class-sms-defaultboundarygroup.md)
### [Método RemoveSiteSystem de la clase SMS_DefaultBoundaryGroup](core/servers/configure/removesitesystem-method-in-class-sms-defaultboundarygroup.md)
## [Clase WMI de servidor SMS_EmbeddedProperty](core/servers/configure/sms_embeddedproperty-server-wmi-class.md)
## [Clase WMI de servidor SMS_EmbeddedPropertyList](core/servers/configure/sms_embeddedpropertylist-server-wmi-class.md)
## [Clase WMI de servidor SMS_Identification](core/servers/configure/sms_identification-server-wmi-class.md)
### [Método GetCurrentUser de la clase SMS_Identification](core/servers/configure/getcurrentuser-method-in-class-sms_identification.md)
### [Método GetFileBinary de la clase SMS_Identification](core/servers/configure/getfilebinary-method-in-class-sms_identification.md)
### [Método GetProviderVersion de la clase SMS_Identification](core/servers/configure/getproviderversion-method-in-class-sms_identification.md)
### [Método GetSiteID de la clase SMS_Identification](core/servers/configure/getsiteid-method-in-class-sms_identification.md)
## [Clase WMI de servidor SMS_RcmSqlControl](core/servers/configure/sms_rcmsqlcontrol-server-wmi-class.md)
## [Clase WMI de servidor SMS_RcmSqlControlProperty](core/servers/configure/sms_rcmsqlcontrolproperty-server-wmi-class.md)
## [Clase WMI de servidor SMS_ReplicationGroup](core/servers/configure/sms_replicationgroup-server-wmi-class.md)
### [Método InitializeData de la clase SMS_ReplicationGroup](core/servers/configure/initializedata-method-in-class-sms_replicationgroup.md)
## [Clase WMI de servidor SMS_ReplicationLinkStatus](core/servers/configure/sms_replicationlinkstatus-server-wmi-class.md)
## [Clase WMI de servidor SMS_ReplicationLinkSummary](core/servers/configure/sms_replicationlinksummary-server-wmi-class.md)
## [Clase WMI de servidor SMS_SCI_Address](core/servers/configure/sms_sci_address-server-wmi-class.md)
## [Clase WMI de servidor SMS_SCI_ClientComp](core/servers/configure/sms_sci_clientcomp-server-wmi-class.md)
## [Clase WMI de servidor SMS_SCI_ClientConfig](core/servers/configure/sms_sci_clientconfig-server-wmi-class.md)
## [Clase WMI de servidor SMS_SCI_Component](core/servers/configure/sms_sci_component-server-wmi-class.md)
## [Clase WMI de servidor SMS_SCI_Configuration](core/servers/configure/sms_sci_configuration-server-wmi-class.md)
## [Clase WMI de servidor SMS_SCI_FileDefinition](core/servers/configure/sms_sci_filedefinition-server-wmi-class.md)
## [Clase WMI de servidor SMS_SCI_MaintenanceTask](core/servers/configure/sms_sci_maintenancetask-server-wmi-class.md)
## [Clase WMI de servidor SMS_SCI_SiteDefinition](core/servers/configure/sms_sci_sitedefinition-server-wmi-class.md)
## [Clase WMI de servidor SMS_SCI_SQLTask](core/servers/configure/sms_sci_sqltask-server-wmi-class.md)
## [Clase WMI de servidor SMS_SCI_SysResUse](core/servers/configure/sms_sci_sysresuse-server-wmi-class.md)
## [Clase WMI de servidor SMS_SII_Property](core/servers/configure/sms_sii_property-server-wmi-class.md)
## [Clase WMI de servidor SMS_SII_PropertyList](core/servers/configure/sms_sii_propertylist-server-wmi-class.md)
## [Clase WMI de servidor SMS_SIIB_AddressType](core/servers/configure/sms_siib_addresstype-server-wmi-class.md)
## [Clase WMI de servidor SMS_SIIB_Component_FileList](core/servers/configure/sms_siib_component_filelist-server-wmi-class.md)
## [Clase WMI de servidor SMS_SIIB_Configuration](core/servers/configure/sms_siib_configuration-server-wmi-class.md)
## [Clase WMI de servidor SMS_SIIB_Generic_Configuration](core/servers/configure/sms_siib_generic_configuration-server-wmi-class.md)
## [Clase WMI de servidor SMS_SIIB_SenderType](core/servers/configure/sms_siib_sendertype-server-wmi-class.md)
## [Clase WMI de servidor SMS_SIIB_SysResRole](core/servers/configure/sms_siib_sysresrole-server-wmi-class.md)
## [Clase WMI de servidor SMS_Site](core/servers/configure/sms_site-server-wmi-class.md)
### [Método EncryptDataEx de la clase SMS_Site](core/servers/configure/encryptdataex-method-in-class-sms_site.md)
### [Método GetAutoUpgradeConfigs de la clase SMS_Site](core/servers/configure/getautoupgradeconfigs-method-in-class-sms_site.md)
### [Método GetClientInfo de la clase SMS_Site](core/servers/configure/getclientinfo-method-in-class-sms_site.md)
### [Método GetClientPilotingConfigs de la clase SMS_Site](core/servers/configure/getclientpilotingconfigs-method-in-class-sms_site.md)
### [Método GetFeatureState de la clase SMS_Site](core/servers/configure/getfeaturestate-method-in-class-sms_site.md)
### [Método GetSiteADInfo de la clase SMS_Site](core/servers/configure/getsiteadinfo-method-in-class-sms_site.md)
### [Método ImportGlobalUserAccount de la clase SMS_Site](core/servers/configure/importglobaluseraccount-method-in-class-sms_site.md)
### [Método ImportGlobalUserAccountEx de la clase SMS_Site](core/servers/configure/importglobaluseraccountex-method-in-class-sms_site.md)
### [Método ImportMachineEntry de la clase SMS_Site](core/servers/configure/importmachineentry-method-in-class-sms_site.md)
### [Método IsUsedCert de la clase SMS_Site](core/servers/configure/isusedcert-method-in-class-sms_site.md)
### [Método RedistributeAutoUpgradeClientContent de la clase SMS_Site](core/servers/configure/redistributeautoupgradeclientcontent-method-in-class-sms_site.md)
### [Método SubmitAMTCert de la clase SMS_Site](core/servers/configure/submitamtcert-method-in-class-sms_site.md)
### [Método SubmitRegistrationRecord de la clase SMS_Site](core/servers/configure/submitregistrationrecord-method-in-class-sms_site.md)
### [Método UpdateAutoUpgradeClientContent de la clase SMS_Site](core/servers/configure/updateautoupgradeclientcontent-method-in-class-sms_site.md)
### [Método UpdateAutoUpgradeConfigs de la clase SMS_Site](core/servers/configure/updateautoupgradeconfigs-method-in-class-sms_site.md)
### [Método UpdateClientPilotingConfigs de la clase SMS_Site](core/servers/configure/updateclientpilotingconfigs-method-in-class-sms_site.md)
### [Método UpdateConsoleUsageData de la clase SMS_Site](core/servers/configure/updateconsoleusagedata-method-in-class-sms_site.md)
### [Método UpdateFeatureState de la clase SMS_Site](core/servers/configure/updatefeaturestate-method-in-class-sms_site.md)
### [Método VerifyNoLoops de la clase SMS_Site](core/servers/configure/verifynoloops-method-in-class-sms_site.md)
## [Clase WMI de servidor SMS_SiteAndSubsites](core/servers/configure/sms_siteandsubsites-server-wmi-class.md)
## [Clase WMI de servidor SMS_SiteControlDaySchedule](core/servers/configure/sms_sitecontroldayschedule-server-wmi-class.md)
## [Clase WMI de servidor SMS_SiteControlFile](core/servers/configure/sms_sitecontrolfile-server-wmi-class.md)
## [Clase WMI de servidor SMS_SiteControlItem](core/servers/configure/sms_sitecontrolitem-server-wmi-class.md)
## [Clase WMI de servidor SMS_SiteInstallItem](core/servers/configure/sms_siteinstallitem-server-wmi-class.md)
## [Clase WMI de servidor SMS_SiteInstallItemBase](core/servers/configure/sms_siteinstallitembase-server-wmi-class.md)
## [Clase WMI de servidor SMS_SiteInstallMap](core/servers/configure/sms_siteinstallmap-server-wmi-class.md)
### [Método Refresh de la clase SMS_SiteInstallMap](core/servers/configure/refresh-method-in-class-sms_siteinstallmap.md)
## [Clase WMI de servidor SMS_SystemResourceList](core/servers/configure/sms_systemresourcelist-server-wmi-class.md)
## [Clase WMI de servidor SMS_SCFToSCI_a](core/servers/configure/sms_scftosci_a-server-wmi-class.md)
## [Clase WMI de servidor SMS_SCFToSite_a](core/servers/configure/sms_scftosite_a-server-wmi-class.md)
## [Clase WMI de servidor SMS_SiteToSubSite_a](core/servers/configure/sms_sitetosubsite_a-server-wmi-class.md)
## [Clase WMI de servidor SMS_SiteToSiteID_a](core/servers/configure/sms_sitetositeid_a-server-wmi-class.md)

# [Clases WMI de servidor de distribución de software](core/servers/configure/software-distribution-server-wmi-classes.md)
## [Clase WMI de servidor SMS_Advertisement](core/servers/configure/sms_advertisement-server-wmi-class.md)
### [Método GetAdvertisements de la clase SMS_Advertisement](core/servers/configure/getadvertisements-method-in-class-sms_advertisement.md)
### [Método GetNextID de la clase SMS_Advertisement](core/servers/configure/getnextid-method-in-class-sms_advertisement.md)
### [Método RiskyDeploymentStatusMessage de la clase SMS_Advertisement](core/servers/configure/riskydeploymentstatusmessage-method-in-class-sms_advertisement.md)
### [Método SetNextID de la clase SMS_Advertisement](core/servers/configure/setnextid-method-in-class-sms_advertisement.md)
### [Método SetSourceSite de la clase SMS_Advertisement](core/servers/configure/setsourcesite-method-in-class-sms_advertisement.md)
### [Método Unlock de la clase SMS_Advertisement](core/servers/configure/unlock-method-in-class-sms_advertisement.md)
## [Clase WMI de servidor SMS_AdvertisementInfo](core/servers/configure/sms_advertisementinfo-server-wmi-class.md)
## [Clase WMI de servidor SMS_AdvertisementStatusInformation](core/servers/configure/sms_advertisementstatusinformation-server-wmi-class.md)
## [Clase WMI de servidor SMS_AdvertToSourceSite_a](core/servers/configure/sms_adverttosourcesite_a-server-wmi-class.md)
## [Clase WMI de servidor SMS_ClassicDeploymentAssetDetails](core/servers/configure/sms_classicdeploymentassetdetails-server-wmi-class.md)
## [Clase WMI de servidor SMS_ClassicDeploymentStatus](core/servers/configure/sms_classicdeploymentstatus-server-wmi-class.md)
## [Clase WMI de servidor SMS_ClientAdvertisementStatus](core/servers/configure/sms_clientadvertisementstatus-server-wmi-class.md)
## [Clase WMI de servidor SMS_ClientAdvertisementSummary](core/servers/configure/sms_clientadvertisementsummary-server-wmi-class.md)
## [Clase WMI de servidor SMS_DistributionDPStatus](core/servers/configure/sms_distributiondpstatus-server-wmi-class.md)
## [Clase WMI de servidor SMS_DistributionJob](core/servers/configure/sms_distributionjob-server-wmi-class.md)
## [Clase WMI de servidor SMS_DistributionPoint](core/servers/configure/sms_distributionpoint-server-wmi-class.md)
### [Método VerifyPackage de la clase SMS_DistributionPoint](core/servers/configure/verifypackage-method-in-class-sms_distributionpoint.md)
### [Método CancelDistribution de la clase SMS_DistributionPoint](core/servers/configure/canceldistribution-method-in-class-sms_distributionpoint.md)
## [Clase WMI de servidor SMS_DistributionPointDriveInfo](core/servers/configure/sms_distributionpointdriveinfo-server-wmi-class.md)
## [Clase WMI de servidor SMS_DistributionPointGroup](core/servers/configure/sms_distributionpointgroup-server-wmi-class.md)
### [Método AddDistributionPoints de la clase SMS_DistributionPointGroup](core/servers/configure/adddistributionpoints-method-in-class-sms_distributionpointgroup.md)
### [Método AddPackages de la clase SMS_DistributionPointGroup](core/servers/configure/addpackages-method-in-class-sms_distributionpointgroup.md)
### [Método AssociateCollections de la clase SMS_DistributionPointGroup](core/servers/configure/associatecollections-method-in-class-sms_distributionpointgroup.md)
### [Método DisassociateCollections de la clase SMS_DistributionPointGroup](core/servers/configure/disassociatecollections-method-in-class-sms_distributionpointgroup.md)
### [Método ReDistributePackage de la clase SMS_DistributionPointGroup](core/servers/configure/redistributepackage-method-in-class-sms_distributionpointgroup.md)
### [Método RefreshDPGroup de la clase SMS_DistributionPointGroup](core/servers/configure/refreshdpgroup-method-in-class-sms_distributionpointgroup.md)
### [Método RemoveDistributionPoints de la clase SMS_DistributionPointGroup](core/servers/configure/removedistributionpoints-method-in-class-sms_distributionpointgroup.md)
### [Método RemovePackages de la clase SMS_DistributionPointGroup](core/servers/configure/removepackages-method-in-class-sms_distributionpointgroup.md)
## [Clase WMI de servidor SMS_DistributionPointInfo](core/servers/configure/sms_distributionpointinfo-server-wmi-class.md)
### [Método GetChainedPullDPs de la clase SMSDistributionPointInfo](core/servers/configure/getchainedpulldps-method-in-class-smsdistributionpointinfo.md)
## [Clase WMI de servidor SMS_DistributionStatus](core/servers/configure/sms_distributionstatus-server-wmi-class.md)
## [Clase WMI de servidor SMS_LastPXEAdvertisement](core/servers/configure/sms_lastpxeadvertisement-server-wmi-class.md)
## [Clase WMI de servidor SMS_OS_Details](core/servers/configure/sms_os_details-server-wmi-class.md)
## [Clase WMI de servidor SMS_Package](core/servers/configure/sms_package-server-wmi-class.md)
### [Método AddChangeNotification de la clase SMS_Package](core/servers/configure/addchangenotification-method-in-class-sms_package.md)
### [Método AddDistributionPoints de la clase SMS_Package](core/servers/configure/adddistributionpoints-method-in-class-sms_package.md)
### [Método CheckDuplicateShareName de la clase SMS_Package](core/servers/configure/checkduplicatesharename-method-in-class-sms_package.md)
### [Método CheckDuplicateSourceName de la clase SMS_Package](core/servers/configure/checkduplicatesourcename-method-in-class-sms_package.md)
### [Método CheckPackageShareForTaskSequenceDeployment de la clase SMS_Package](core/servers/configure/checkpackagesharefortasksequencedeployment-method-in-class-sms_package.md)
### [Método RefreshPkgSource de la clase SMS_Package](core/servers/configure/refreshpkgsource-method-in-class-sms_package.md)
### [Método SetSourceSite de la clase SMS_Package](core/servers/configure/setsourcesite-method-in-class-sms_package.md)
### [Método Unlock de la clase SMS_Package](core/servers/configure/unlock-method-in-class-sms_package.md)
## [Clase WMI de servidor SMS_PackageAccessByUsers](core/servers/configure/sms_packageaccessbyusers-server-wmi-class.md)
## [Clase WMI de servidor SMS_PackageBaseclass](core/servers/configure/sms_packagebaseclass-server-wmi-class.md)
## [Clase WMI de servidor SMS_PackageStatus](core/servers/configure/sms_packagestatus-server-wmi-class.md)
## [Clase WMI de servidor SMS_PackageStatusDetailSummarizer](core/servers/configure/sms_packagestatusdetailsummarizer-server-wmi-class.md)
## [Clase WMI de servidor SMS_PackageStatusDistPointsSummarizer](core/servers/configure/sms_packagestatusdistpointssummarizer-server-wmi-class.md)
## [Clase WMI de servidor SMS_PackageStatusRootSummarizer](core/servers/configure/sms_packagestatusrootsummarizer-server-wmi-class.md)
## [Clase WMI de servidor SMS_PackageToAdvert_a](core/servers/configure/sms_packagetoadvert_a-server-wmi-class.md)
## [Clase WMI de servidor SMS_PackageToContent](core/servers/configure/sms_packagetocontent-server-wmi-class.md)
### [Método IsContentValid en la clase SMS_PackageToContent](core/servers/configure/iscontentvalid-method-in-class-sms_packagetocontent.md)
## [Clase WMI de servidor SMS_PackageToSourceSite_a](core/servers/configure/sms_packagetosourcesite_a-server-wmi-class.md)
## [Clase WMI de servidor SMS_PDF_Package](core/servers/configure/sms_pdf_package-server-wmi-class.md)
### [Método GetPDFData de la clase SMS_PDF_Package](core/servers/configure/getpdfdata-method-in-class-sms_pdf_package.md)
### [Método LoadIconForPDF de la clase SMS_PDF_Package](core/servers/configure/loadiconforpdf-method-in-class-sms_pdf_package.md)
### [Método LoadPDF de la clase SMS_PDF_Package](core/servers/configure/loadpdf-method-in-class-sms_pdf_package.md)
### [Método ProcessInBox de la clase SMS_PDF_Package](core/servers/configure/processinbox-method-in-class-sms_pdf_package.md)
## [Clase WMI de servidor SMS_PDF_Program](core/servers/configure/sms_pdf_program-server-wmi-class.md)
## [Clase WMI de servidor SMS_PDFPkgToPDFProgram_a](core/servers/configure/sms_pdfpkgtopdfprogram_a-server-wmi-class.md)
## [Clase WMI de servidor SMS_PkgToPkgAccess_a](core/servers/configure/sms_pkgtopkgaccess_a-server-wmi-class.md)
## [Clase WMI de servidor SMS_PkgToPkgProgram_a](core/servers/configure/sms_pkgtopkgprogram_a-server-wmi-class.md)
## [Clase WMI de servidor SMS_PkgToPkgServer_a](core/servers/configure/sms_pkgtopkgserver_a-server-wmi-class.md)
## [Clase WMI de servidor SMS_Program](core/servers/configure/sms_program-server-wmi-class.md)
## [Clase WMI de servidor SMS_ServiceWindow](core/servers/configure/sms_servicewindow-server-wmi-class.md)
## [Clase WMI de servidor SMS_SupportedPlatforms](core/servers/configure/sms_supportedplatforms-server-wmi-class.md)
### [Método Enable de la clase SMS_SupportedPlatforms](core/servers/configure/enable-method-in-class-sms_supportedplatforms.md)
## [Clase WMI de servidor SMS_SupportedPlatformsOfflineServicing](core/servers/configure/sms_supportedplatformsofflineservicing-server-wmi-class.md)

# [Clases WMI de servidor medición de software](apps/software-metering-server-wmi-classes.md)
## [Clase WMI de servidor SMS_FileUsageSummary](apps/sms_fileusagesummary-server-wmi-class.md)
## [Clase WMI de servidor SMS_G_System_SoftwareUsageData](apps/sms_g_system_softwareusagedata-server-wmi-class.md)
## [Clase WMI de servidor SMS_MeterData](apps/sms_meterdata-server-wmi-class.md)
## [Clase WMI de servidor SMS_MeteredFiles](apps/sms_meteredfiles-server-wmi-class.md)
## [Clase WMI de servidor SMS_MeteredProductRule](apps/sms_meteredproductrule-server-wmi-class.md)
## [Clase WMI de servidor SMS_MeteredUser](apps/sms_metereduser-server-wmi-class.md)
## [Clase WMI de servidor SMS_MonthlyUsageSummary](apps/sms_monthlyusagesummary-server-wmi-class.md)
## [Clase WMI del servidor SMS_ProductFileInfo](apps/sms_productfileinfo-server-wmi-class.md)
## [Clase WMI de servidor SMS_SummarizationInterval](apps/sms_summarizationinterval-server-wmi-class.md)

# [Clases WMI de servidor de actualizaciones de software](sum/software-updates-server-wmi-classes.md)
## [Clase WMI de servidor SMS_ADRDeploymentSettings](sum/sms_adrdeploymentsettings-server-wmi-class.md)
## [Clase WMI de servidor SMS_AutoDeployment](sum/sms_autodeployment-server-wmi-class.md)
### [Método EvaluateAllAutoDeployment de la clase SMS_AutoDeployment](sum/evaluateallautodeployment-method-in-class-sms_autodeployment.md)
### [Método EvaluateAutoDeployment de la clase SMS_AutoDeployment](sum/evaluateautodeployment-method-in-class-sms_autodeployment.md)
## [Clase WMI de servidor SMS_AuthorizationList](sum/sms_authorizationlist-server-wmi-class.md)
### [Método RunAuthListStatusSummarization de la clase SMS_AuthorizationList](sum/runauthliststatussummarization-method-in-class-sms_authorizationlist.md)
## [Clase WMI de servidor SMS_CIAllCategories](sum/sms_ciallcategories-server-wmi-class.md)
## [Clase WMI de servidor SMS_CIContentFiles](sum/sms_cicontentfiles-server-wmi-class.md)
## [Clase WMI de servidor SMS_CIRelation](sum/sms_cirelation-server-wmi-class.md)
## [Clase WMI de servidor SMS_CIToContent](sum/sms_citocontent-server-wmi-class.md)
## [Clase WMI de servidor SMS_CIUpdateSources](sum/sms_ciupdatesources-server-wmi-class.md)
## [Clase WMI de servidor SMS_CM_UpdateFeatures](sum/sms_cm_updatefeatures-server-wmi-class.md)
### [Método UpdateFeatureExposureStatus de la clase SMS_CM_UpdateFeatures](sum/updatefeatureexposurestatus-method-in-class-sms_cm_updatefeatures.md)
## [Clase WMI de servidor SMS_CM_UpdatePackageFeatures](sum/sms_cm_updatepackagefeatures-server-wmi-class.md)
### [Método UpdateFeatureExposureStatus de la clase SMS_CM_UpdatePackageFeatures](sum/updatefeatureexposurestatus-method-in-class-sms_cm_updatepackagefeatures.md)
## [Clase WMI de servidor SMS_CM_UpdatePackages](sum/sms_cm_updatepackages-server-wmi-class.md)
### [Método IsCurrentWorkingUpdatePackage de la clase SMS_CM_UpdatePackages](sum/iscurrentworkingupdatepackage-method-in-class-sms_cm_updatepackages.md)
### [Método RetryContentReplication de la clase SMS_CM_UpdatePackages](sum/retrycontentreplication-method-in-class-sms_cm_updatepackages.md)
### [Método SetIgnorePrereqWarning de la clase SMS_CM_UpdatePackages](sum/setignoreprereqwarning-method-in-class-sms_cm_updatepackages.md)
### [Método UpdatePrereqAndStateFlags de la clase SMS_CM_UpdatePackages](sum/updateprereqandstateflags-method-in-class-sms_cm_updatepackages.md)
## [Clase WMI de servidor SMS_CM_UpdatePackagesHistory](sum/sms_cm_updatepackageshistory-server-wmi-class.md)
## [Clase WMI de servidor SMS_CM_UpdatePackageSiteStatus](sum/sms_cm_updatepackagesitestatus-server-wmi-class.md)
### [Método UpdatePackageSiteState de la clase SMS_CM_UpdatePackageSiteStatus](sum/updatepackagesitestate-method-in-class-sms_cm_updatepackagesitestatus.md)
## [Clase WMI de servidor SMS_CM_UpdatePackDetailedMonitoring](sum/sms_cm_updatepackdetailedmonitoring-server-wmi-class.md)
## [Clase WMI de servidor SMS_CM_UpdatePackDetailedPrereqMonitoring](sum/sms_cm_updatepackdetailedprereqmonitoring-server-wmi-class.md)
## [Clase WMI de servidor SMS_CM_UpdatePackDetailedSiteStatus](sum/sms_cm_updatepackdetailedsitestatus-server-wmi-class.md)
## [Clase WMI de servidor SMS_CM_UpdatePackDownloadMonitoring](sum/sms_cm_updatepackdownloadmonitoring-server-wmi-class.md)
## [Clase WMI de servidor SMS_CM_UpdatePackTopLevelMonitoring](sum/sms_cm_updatepacktoplevelmonitoring-server-wmi-class.md)
## [Clase WMI de servidor SMS_EULAContent](sum/sms_eulacontent-server-wmi-class.md)
## [Clase WMI de servidor SMS_FeatureExtension](sum/sms_featureextension-server-wmi-class.md)
## [Clase WMI de servidor SMS_ServicePlan](sum/sms_serviceplan-server-wmi-class.md)
## [Clase WMI de servidor SMS_SoftwareUpdate](sum/sms_softwareupdate-server-wmi-class.md)
### [Método AcceptEULA de la clase SMS_SoftwareUpdate](sum/accepteula-method-in-class-sms_softwareupdate.md)
### [Método GetEULA de la clase SMS_SoftwareUpdate](sum/geteula-method-in-class-sms_softwareupdate.md)
### [Método SetEnforcement de la clase SMS_SoftwareUpdate](sum/setenforcement-method-in-class-sms_softwareupdate.md)
### [Método SyncNow de la clase SMS_SoftwareUpdate](sum/syncnow-method-in-class-sms_softwareupdate.md)
## [Clase WMI de servidor SMS_SoftwareUpdateBase](sum/sms_softwareupdatebase-server-wmi-class.md)
## [Clase WMI de servidor SMS_SoftwareUpdateSource](sum/sms_softwareupdatesource-server-wmi-class.md)
## [Clase WMI de servidor SMS_SoftwareUpdatesPackage](sum/sms_softwareupdatespackage-server-wmi-class.md)
### [Método AddChangeNotification de la clase SMS_SoftwareUpdatesPackage](sum/addchangenotification-method-in-class-sms_softwareupdatespackage.md)
### [Método AddDistributionPoints de la clase SMS_SoftwareUpdatesPackage](sum/adddistributionpoints-method-in-class-sms_softwareupdatespackage.md)
### [Método AddUpdateContent de la clase SMS_SoftwareUpdatesPackage](sum/addupdatecontent-method-in-class-sms_softwareupdatespackage.md)
### [Método RebuildPackage de la clase SMS_SoftwareUpdatesPackage](sum/rebuildpackage-method-in-class-sms_softwareupdatespackage.md)
### [Método RefreshPkgSource de la clase SMS_SoftwareUpdatesPackage](sum/refreshpkgsource-method-in-class-sms_softwareupdatespackage.md)
### [Método RemoveContent de la clase SMS_SoftwareUpdatesPackage](sum/removecontent-method-in-class-sms_softwareupdatespackage.md)
### [Método SetSourceSite de la clase SMS_SoftwareUpdatesPackage](sum/setsourcesite-method-in-class-sms_softwareupdatespackage.md)
### [Método Unlock de la clase SMS_SoftwareUpdatesPackage](sum/unlock-method-in-class-sms_softwareupdatespackage.md)
### [Método ValidateNewPackageSource de la clase SMS_SoftwareUpdatesPackage](sum/validatenewpackagesource-method-in-class-sms_softwareupdatespackage.md)
## [Clase WMI de servidor SMS_SUMDeploymentAssetDetails](sum/sms_sumdeploymentassetdetails-server-wmi-class.md)
## [Clase WMI de servidor SMS_SUMDeploymentStatistics](sum/sms_sumdeploymentstatistics-server-wmi-class.md)
## [Clase WMI de servidor SMS_SUMDeploymentStatus](sum/sms_sumdeploymentstatus-server-wmi-class.md)
## [Clase WMI de servidor SMS_SUPSyncStatus](sum/sms_supsyncstatus-server-wmi-class.md)
## [Clase WMI de servidor SMS_Template](sum/sms_template-server-wmi-class.md)
## [Clase WMI de servidor SMS_UpdateCategoryInstance](sum/sms_updatecategoryinstance-server-wmi-class.md)
## [Clase WMI de servidor SMS_UpdateComplianceStatus](sum/sms_updatecompliancestatus-server-wmi-class.md)
## [Clase WMI de servidor SMS_UpdateDeploymentSummary](sum/sms_updatedeploymentsummary-server-wmi-class.md)
## [Clase WMI de servidor SMS_UpdateGroupAssignment](sum/sms_updategroupassignment-server-wmi-class.md)
## [Clase WMI de servidor SMS_UpdatesAssignment](sum/sms_updatesassignment-server-wmi-class.md)

# [Clases WMI de servidor de compatibilidad](misc/supporting-server-wmi-classes.md)
## [Clase WMI de servidor SMS_ContextMethods](misc/sms_contextmethods-server-wmi-class.md)
### [Método ClearContextHandle de la clase SMS_ContextMethods](misc/clearcontexthandle-method-in-class-sms_contextmethods.md)
### [Método GetContextHandle de la clase SMS_ContextMethods](misc/getcontexthandle-method-in-class-sms_contextmethods.md)
## [Clase WMI de servidor SMS_ExtendedStatus](misc/sms_extendedstatus-server-wmi-class.md)
## [Clase WMI de servidor SMS_NAL_Methods](misc/sms_nal_methods-server-wmi-class.md)
### [Método PackNALPath de la clase SMS_NAL_Methods](misc/packnalpath-method-in-class-sms_nal_methods.md)
### [Método UnPackNALPath de la clase SMS_NAL_Methods](misc/unpacknalpath-method-in-class-sms_nal_methods.md)
## [Clase WMI de servidor SMS_ProviderLocation](misc/sms_providerlocation-server-wmi-class.md)

# [Clases de estado](core/servers/manage/status-classes.md)
## [API de cliente de estado](core/servers/manage/status-client-apis.md)
### [Funciones de mensajes de estado Smscstat.dll](core/servers/manage/smscstat.dll-status-message-functions.md)
#### [Función AddAttributeToSMSStatusMessage](core/servers/manage/addattributetosmsstatusmessage-function.md)
#### [Función CreateSMSStatusMessage](core/servers/manage/createsmsstatusmessage-function.md)
#### [Función ReportSMSStatusMessage](core/servers/manage/reportsmsstatusmessage-function.md)
### [Clase SMSEvent](core/servers/manage/smsevent-class.md)
#### [Propiedad ICCMEvent::EventType](core/servers/manage/iccmevent--eventtype-property.md)
#### [Propiedad ICCMEvent::RawEvent](core/servers/manage/iccmevent--rawevent-property.md)
...
## [Tipos de mensaje de estado](core/servers/manage/status-message-types.md)
...
## [Funciones de MIF de estado](core/servers/manage/status-mif-functions.md)
### [Función Create](core/servers/manage/create-function.md)
### [Función InstallStatusMIF](core/servers/manage/installstatusmif-function.md)
### [Función InstallStatusMIFEx](core/servers/manage/installstatusmifex-function.md)
## [API de servidor de estado](core/servers/manage/status-server-api.md)
### [Clase SMSFormatMessageCtl](core/servers/manage/smsformatmessagectl-class.md)
...
## [Clases WMI de servidor de estado](core/servers/manage/status-server-wmi-classes.md)
### [Clase WMI de servidor SMS_ComponentSummarizer](core/servers/manage/sms_componentsummarizer-server-wmi-class.md)
#### [Método DeleteStatistics de la clase SMS_ComponentSummarizer](core/servers/manage/deletestatistics-method-in-class-sms_componentsummarizer.md)
### [Clase WMI de servidor SMS_SecondarySiteStatus](core/servers/manage/sms_secondarysitestatus-server-wmi-class.md)
### [Clase WMI de servidor SMS_SiteDetailSummarizer](core/servers/manage/sms_sitedetailsummarizer-server-wmi-class.md)
### [Clase WMI de servidor SMS_SiteSystemSummarizer](core/servers/manage/sms_sitesystemsummarizer-server-wmi-class.md)
### [Clase WMI de servidor SMS_StatAttr](core/servers/manage/sms_statattr-server-wmi-class.md)
### [Clase WMI de servidor SMS_StatInsStr](core/servers/manage/sms_statinsstr-server-wmi-class.md)
### [Clase WMI de servidor SMS_StatMsg](core/servers/manage/sms_statmsg-server-wmi-class.md)
### [Clase WMI de servidor SMS_StatMsgAttributes](core/servers/manage/sms_statmsgattributes-server-wmi-class.md)
### [Clase WMI de servidor SMS_StatMsgInsStrings](core/servers/manage/sms_statmsginsstrings-server-wmi-class.md)
### [Clase WMI de servidor SMS_StatMsgModuleNames](core/servers/manage/sms_statmsgmodulenames-server-wmi-class.md)
### [Clase WMI de servidor SMS_StatMsgWithInsStrings](core/servers/manage/sms_statmsgwithinsstrings-server-wmi-class.md)
### [Clase WMI de servidor SMS_StatusMessage](core/servers/manage/sms_statusmessage-server-wmi-class.md)
#### [Método DeleteByID de la clase SMS_StatusMessage](core/servers/manage/deletebyid-method-in-class-sms_statusmessage.md)
#### [Método DeleteByQuery de la clase SMS_StatusMessage](core/servers/manage/deletebyquery-method-in-class-sms_statusmessage.md)
#### [Método RaiseErrorStatusMsg de la clase SMS_StatusMessage](core/servers/manage/raiseerrorstatusmsg-method-in-class-sms_statusmessage.md)
#### [Método RaiseInformationalStatusMsg de la clase SMS_StatusMessage](core/servers/manage/raiseinformationalstatusmsg-method-in-class-sms_statusmessage.md)
#### [Método RaiseRawStatusMsg de la clase SMS_StatusMessage](core/servers/manage/raiserawstatusmsg-method-in-class-sms_statusmessage.md)
#### [Método RaiseWarningStatusMsg de la clase SMS_StatusMessage](core/servers/manage/raisewarningstatusmsg-method-in-class-sms_statusmessage.md)
### [Clase WMI de servidor SMS_SummarizerRootStatus](core/servers/manage/sms_summarizerrootstatus-server-wmi-class.md)
#### [Método GetTallyIntervals de la clase SMS_SummarizerRootStatus](core/servers/manage/gettallyintervals-method-in-class-sms_summarizerrootstatus.md)
### [Clase WMI de servidor SMS_SummarizationSettings](core/servers/manage/sms_summarizationsettings-server-wmi-class.md)
#### [Método GetSummarizationSettings de la clase SMS_SummarizationSettings](core/servers/manage/getsummarizationsettings-method-in-class-sms_summarizationsettings.md)
#### [Método SetSummarizationSettings de la clase SMS_SummarizationSettings](core/servers/manage/setsummarizationsettings-method-in-class-sms_summarizationsettings.md)
### [Clase WMI de servidor SMS_SummarizerSiteStatus](core/servers/manage/sms_summarizersitestatus-server-wmi-class.md)
### [Clase WMI de servidor SMS_SummarizerStatus](core/servers/manage/sms_summarizerstatus-server-wmi-class.md)

# [Clases WMI de servidor de Microsoft Azure](core/servers/configure/windows-azure-server-wmi-classes.md)
## [Clase WMI de servidor SMS_AzureService](core/servers/configure/sms_azureservice-server-wmi-class.md)
### [Método Start de la clase SMS_AzureService](core/servers/configure/start-method-in-class-sms_azureservice.md)
### [Método Stop de la clase SMS_AzureService](core/servers/configure/stop-method-in-class-sms_azureservice.md)
## [Clase WMI de servidor SMS_AzureServicesTask](core/servers/configure/sms_azureservicestask-server-wmi-class.md)

# [Clases WMI de servidor de servicio de Windows 10](misc/windows-10-servicing-server-wmi-classes.md)
## [Clase WMI de servidor SMS_AdminUIContent](misc/sms-adminuicontent-server-wmi-class.md)
## [Clase WMI de servidor SMS_Windows10Dashboard](misc/sms_windows10dashboard-server-wmi-class.md)
## [Clase WMI de servidor SMS_WindowsServicingBusinessReadyUpdates](misc/sms_windowsservicingbusinessreadyupdates-server-wmi-class.md)
## [Clase WMI de servidor SMS_WindowsServicingLocalizedNames](misc/sms_windowsservicinglocalizednames-server-wmi-class.md)
## [Clase WMI de servidor SMS_WindowsServicingStates](misc/sms_windowsservicingstates-server-wmi-class.md)

# [Referencia administrada de Configuration Manager](https://msdn.microsoft.com/library/mt767606.aspx)
