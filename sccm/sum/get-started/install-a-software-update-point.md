...
## <a name="supersedence-rules"></a>Reglas de sustitución  
 Configure los parámetros de sustitución en la página **Reglas de sustitución** del asistente o en la pestaña **Reglas de sustitución** , en Propiedades de componente de punto de actualización de software. Las reglas de sustitución solo se pueden configurar en el sitio de nivel superior. A partir de la versión de Configuration Manager 1810, puede especificar el comportamiento de las reglas de sustitución para **las actualizaciones de características** por separado desde **actualizaciones que no son características**. <!--3098809, 2977644-->
