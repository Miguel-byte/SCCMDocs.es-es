---
title: Crear perfiles de certificado | System Center Configuration Manager
...
---
# <a name="how-to-create-certificate-profiles-in-system-center-configuration-manager"></a>Cómo crear perfiles de certificado en System Center Configuration Manager

*Se aplica a: System Center Configuration Manager (rama actual)*


Use perfiles de certificado para aprovisionar dispositivos administrados con los certificados que necesitan para obtener acceso a recursos de empresa. Antes de crear perfiles de certificado, configure la infraestructura de certificados como se describe en [Set up certificate infrastructure for System Center Configuration Manager](certificate-infrastructure.md) (Configurar la infraestructura de certificados para System Center Configuration Manager).  
...
2.  Complete la página **Inscripción de SCEP** del Asistente para crear perfil de certificado mediante las instrucciones siguientes.
