---
title: "Actualizar un equipo existente con una nueva versión de Windows | Configuration Manager"
...
-   **Supervisar la implementación de la secuencia de tareas**  
     ...
     Para supervisar la implementación de la secuencia de tareas para instalar el sistema operativo, consulte [Monitor operating system deployments](monitor-operating-system-deployments.md) (Supervisar implementaciones del sistema operativo).  
