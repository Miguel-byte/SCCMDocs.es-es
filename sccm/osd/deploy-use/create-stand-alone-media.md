---
title: Crear medios independientes con System Center Configuration Manager
...
7.  En la página **CD/DVD independiente** , especifique la secuencia de tareas que implementa el sistema operativo y, a continuación, haga clic en **Siguiente**. El asistente le permite seleccionar las secuencias de tareas asociadas con una imagen de arranque.  
...
##  <a name="a-namebkmkstandalonemediatsexamplea-example-task-sequence-for-stand-alone-media"></a><a name="BKMK_StandAloneMediaTSExample"></a> Ejemplo de secuencia de tareas de medios independientes  
