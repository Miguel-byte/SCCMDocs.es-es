...
description: Configure los roles de sistema de sitio antes de implementar los sistemas operativos.
ms.date: 03/22/2018
...
Para implementar sistemas operativos en Configuration Manager, primero debe preparar los siguientes roles de sistema de sitio que requieren configuraciones y consideraciones específicas.
...
-   **¿Cómo puedo impedir las implementaciones de SO no deseadas?**  
...
-   **¿Cuántos equipos pueden recibir una imagen de SO al mismo tiempo desde un único punto de distribución?**  
    ...
    Por ejemplo, si no se tienen en cuenta otros factores de recursos del servidor, el número máximo de equipos que pueden procesar un paquete de imágenes de 4 gigabytes (GB) en una hora en una red Ethernet de 100 megabits por segundo es de 11 equipos.  
...
-   **¿Puedo implementar un SO en un punto de distribución?**  
...
Para personalizar el tamaño de la ventana de TFTP de RamDisk, agregue la clave del Registro siguiente a los puntos de distribución habilitados con PXE:  
  ...
  - **Tipo**: REG_DWORD  
  - **Valor**: &lt;tamaño de ventana personalizado>  </br>
...
Para personalizar el tamaño de la ventana de TFTP de RamDisk, agregue la clave del Registro siguiente a los puntos de distribución habilitados con PXE:  
  ...
  - **Tipo**: REG_DWORD  
  - **Valor**: &lt;tamaño de bloque personalizado>  </br>
