...
##  <a name="BKMK_OSDeploymentProcess"></a> El proceso de implementación de sistema operativo  
...
##  <a name="BKMK_OSDScenarios"></a> Escenarios de implementación de sistema operativo  
...
##  <a name="BKMK_BootImages"></a> Imágenes de arranque  
...
##  <a name="BKMK_OSImages"></a> Imágenes de sistema operativo  
...
##  <a name="BKMK_OSUpgradePackages"></a> Paquetes de actualización del sistema operativo  
...
##  <a name="BKMK_OSDMedia"></a> Medios usados para implementar sistemas operativos  
...
##  <a name="BKMK_OSDUserState"></a> Guardar y restaurar el estado de usuario  
...
##  <a name="BKMK_UnknownComputer"></a> Implementación en equipos desconocidos  
...
##  <a name="BKMK_TaskSequences"></a> Usar secuencias de tareas para automatizar etapas  
