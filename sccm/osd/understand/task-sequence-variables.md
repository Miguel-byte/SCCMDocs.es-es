...
### <a name="OSDDoNotLogCommand"></a> OSDDoNotLogCommand
 <!--1358493--> *A partir de la versión 1806*  
...
<!--516679/2840016--> *A partir de la versión 1806*  
...
### <a name="SMSTSDisableStatusRetry"></a> SMSTSDisableStatusRetry
 <!--512358--> En escenarios desconectados, el motor de secuencia de tareas intenta repetidamente enviar mensajes de estado al punto de administración. Este comportamiento en este escenario provoca retrasos en el procesamiento de la secuencia de tareas. 
