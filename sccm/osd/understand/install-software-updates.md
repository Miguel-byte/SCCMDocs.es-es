...
3. *¿Es la primera vez que se llama a esta instancia?*  
    ...
    2. **No**: *¿El paso está configurado con la opción de [Evaluación de las actualizaciones de software a partir de los resultados del análisis en caché](/sccm/osd/understand/task-sequence-steps#evaluate-software-updates-from-cached-scan-results)?*
