...
---
# <a name="create-configuration-items-for-ios-and-mac-os-x-devices-managed-with-intune"></a>Creación de elementos de configuración para dispositivos iOS y Mac OS X administrados con Intune
...
8.  En la página **Configuración del dispositivo**, seleccione el grupo de configuración que quiere configurar. Consulte [Referencia de configuración de elementos de configuración de iOS y Mac OS X](#ios-and-mac-os-x-configuration-item-settings-reference) en este tema para obtener detalles y luego haga clic en **Siguiente**.  
