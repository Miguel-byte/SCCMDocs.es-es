...
---
# <a name="how-to-create-configuration-items-for-windows-phone-devices-managed-with-intune"></a>Creación de elementos de configuración para dispositivos Windows Phone administrados con Intune
...
8.  En la página **Configuración del dispositivo**, seleccione el grupo de configuración que quiere configurar. Consulte [Referencia de configuración de elementos de configuración de Windows Phone](#windows-phone-configuration-item-settings-reference) en este tema para obtener más información y, después, haga clic en **Siguiente**.  
