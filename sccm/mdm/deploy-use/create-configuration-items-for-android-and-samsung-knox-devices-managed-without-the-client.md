...
---
# <a name="create-configuration-items-for-android-and-samsung-knox-standard-devices-managed-with-intune"></a>Creación de elementos de configuración para dispositivos Android y Samsung KNOX Standard administrados con Intune
...
8.  En la página **Configuración del dispositivo**, seleccione el grupo de configuración que quiere configurar. Consulte [Referencia de configuración de elementos de configuración de Android y Samsung KNOX Standard](#android-and-samsung-knox-standard-configuration-item-settings-reference) en este tema para obtener detalles y luego haga clic en **Siguiente**.  
