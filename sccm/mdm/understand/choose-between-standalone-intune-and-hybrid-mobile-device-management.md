---
title: Elegir Intune independiente
titleSuffix: Configuration Manager
description: Elegir Intune independiente
ms.date: 08/14/2018
...
A partir del 14 de agosto de 2018, la administración de dispositivos móviles (MDM) híbrida es una [característica en desuso](/sccm/core/plan-design/changes/deprecated/removed-and-deprecated-cmfeatures). Intune en Azure es la solución de MDM recomendada por Microsoft.  

Para más información, vea [¿Qué es la Administración híbrida de dispositivos móviles (MDM)?](/sccm/mdm/understand/hybrid-mobile-device-management). <!--Intune feature 2683117-->  
